...
from data_enums.whisper_local_models import WhisperMultiLingualModels, WhisperEnglishModels
...
class AppParams:
    ...
    source_language: Optional[str | ISO639Language] = None
    source_language_dialect: Optional[str | ISO3166Regions] = None
    whisper_local_chosen_model: Optional[str |WhisperMultiLingualModels] | Optional[str | WhisperEnglishModels] = None
