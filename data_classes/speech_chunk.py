...
class SpeechChunk:
	...
	transcription_file_path: Path | None | None = None
	transcription_source_language_path: Path | None | None = None
	transcription_target_language_path: Path | None | None = None
