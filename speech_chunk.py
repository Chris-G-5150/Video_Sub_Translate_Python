...
class SpeechChunk:
    def __init__(self, clip_srt_index, project_title):
        self.project_title = project_title
        self.clip_srt_index = clip_srt_index
        self.clip_name = None
        self.path_to_clip = None
        self.audio_file_type = None
        self.time_stamp_start = None
        self.time_stamp_end = None
        self.platform_translated_from = None
        self.source_language = None
        self.detected_language = None
        self.transcribed_audio = None

        # Supported languages hardcoded per model, look this up before testing with each API
        self.supported_languages = {
            "whisper": ["en", "de", "fr", "es"],
            "google_translate": ["en", "de", "fr", "es", "it", "ja"],
        }
